    ...
    return (
            <Modal isOpen={true} className={"w-2/3 p-10"}>
                ...
                <div className="flex flex-col items-center md:flex-row gap-x-24 gap-y-2 md:gap-y-0">
                    ...
                    <button
                        type="submit"
                        className="rounded-xl bg-yellow-300 font-semibold text-blue-600 w-80 h-12 transitition duration-300 ease-in-out hover:bg-yellow-400 hover:-translate-y-1"
                        >
                        Send
                        </button>
                    </div>
